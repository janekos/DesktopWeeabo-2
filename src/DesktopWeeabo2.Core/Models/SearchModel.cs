...
namespace DesktopWeeabo2.Core.Models {
	...
	public class SearchModel {
		...
		public SortObject[] InitSortsList() => new SortObject[] {
			...
			new SortObject("Native title",   "TITLE_NATIVE",  nameof(BaseModel.Title.Native),    SortLocation.ONLINE),
			new SortObject("Romaji title",   "TITLE_ROMAJI",  nameof(BaseModel.Title.Romaji),    SortLocation.ONLINE),
			new SortObject("English title",  "TITLE_ENGLISH", nameof(BaseModel.Title.English),   SortLocation.ONLINE),
