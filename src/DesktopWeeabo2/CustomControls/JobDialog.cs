...
namespace DesktopWeeabo2.CustomControls {
	...
	public class JobDialog : Control {
		...
		public string JobStage {
			get { return (string) GetValue(JobStageProperty); }
			set { SetValue(JobStageProperty, value); }
		}

		public static readonly DependencyProperty JobStageProperty = DependencyProperty.Register("JobStage", typeof(string), typeof(JobDialog), new PropertyMetadata(null));
	}
}